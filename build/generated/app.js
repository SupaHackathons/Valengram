...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ValenForm = __webpack_require__(9);

	var _ValenForm2 = _interopRequireDefault(_ValenForm);

	var _Valentine = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Root = function (_Component) {
	  ...
	  function Root() {
	    ...
	    }, _this.onFormSubmit = function (val) {
	      _this.setState({
	        valData: val
	      });
	  ...
	  _createClass(NavBar, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: _navbar2.default.navItem },
	          _react2.default.createElement(
	            _reactRouter.Link,
	            { to: '/' },
	            'Home'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Valengram = __webpack_require__(11);
	...
	var ValenForm = function (_Component) {
	  ...
	  function ValenForm() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ValenForm)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      ...
	      e.preventDefault();
	      var text = [];
	      (0, _map2.default)(e.target.getElementsByTagName('input'), function (input) {
	      ...
	      _this.props.onFormSubmit(submitData);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'text',
	            className: _Valengram2.default.questionInput,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var equalArrays = __webpack_require__(20),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Valentine = __webpack_require__(63);

	var _Valentine2 = _interopRequireDefault(_Valentine);

	var _ScrollItem = __webpack_require__(65);
	...
	var Valentine = function (_Component) {
	  _inherits(Valentine, _Component);
	  ...
	  function Valentine() {
	    ...
	    _classCallCheck(this, Valentine);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Valentine)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      transform: 0
	    ...
	    }, _this._mkValImage = function (file, idx) {
	      var text = _this.props.valData.text;

	      return _react2.default.createElement(_ScrollItem2.default, { source: file.preview,
	        text: text[idx],
	        key: idx,
	        idx: idx });
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  ...
	  _createClass(Valentine, [{
	    key: 'render',
	    value: function render() {
	      var valData = this.props.valData;
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"heart":"Valentine__heart___346CX"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ScrollItem = __webpack_require__(67);
